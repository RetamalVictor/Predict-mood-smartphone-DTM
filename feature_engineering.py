...
res["moving_average_activity"] = (
    res.groupby(["id"])["activity"]
    .rolling(7)
    .mean()
    .reset_index(level=[0, 1], drop=True)
)
res["moving_average_builtin"] = (
    res.groupby(["id"])["appCat.builtin"]
    .rolling(7)
    .mean()
    .reset_index(level=[0, 1], drop=True)
)
res["moving_average_communication"] = (
    res.groupby(["id"])["appCat.communication"]
    .rolling(7)
    .mean()
    .reset_index(level=[0, 1], drop=True)
)
res["moving_average_entertainment"] = (
    res.groupby(["id"])["appCat.entertainment"]
    .rolling(7)
    .mean()
    .reset_index(level=[0, 1], drop=True)
)
res["moving_average_finance"] = (
    res.groupby(["id"])["appCat.finance"]
    .rolling(7)
    .mean()
    .reset_index(level=[0, 1], drop=True)
)
res["moving_average_game"] = (
    res.groupby(["id"])["appCat.game"]
    .rolling(7)
    .mean()
    .reset_index(level=[0, 1], drop=True)
)
res["moving_average_office"] = (
    res.groupby(["id"])["appCat.office"]
    .rolling(7)
    .mean()
    .reset_index(level=[0, 1], drop=True)
)
res["moving_average_other"] = (
    res.groupby(["id"])["appCat.other"]
    .rolling(7)
    .mean()
    .reset_index(level=[0, 1], drop=True)
)
res["moving_average_social"] = (
    res.groupby(["id"])["appCat.social"]
    .rolling(7)
    .mean()
    .reset_index(level=[0, 1], drop=True)
)
res["moving_average_travel"] = (
    res.groupby(["id"])["appCat.travel"]
    .rolling(7)
    .mean()
    .reset_index(level=[0, 1], drop=True)
)
res["moving_average_unknown"] = (
    res.groupby(["id"])["appCat.unknown"]
    .rolling(7)
    .mean()
    .reset_index(level=[0, 1], drop=True)
)
res["moving_average_utilities"] = (
    res.groupby(["id"])["appCat.utilities"]
    .rolling(7)
    .mean()
    .reset_index(level=[0, 1], drop=True)
)
res["moving_average_weather"] = (
    res.groupby(["id"])["appCat.weather"]
    .rolling(7)
    .mean()
    .reset_index(level=[0, 1], drop=True)
)
res["moving_average_call"] = (
    res.groupby(["id"])["call"].rolling(7).mean().reset_index(level=[0, 1], drop=True)
)
res["moving_average_arousal"] = (
    res.groupby(["id"])["circumplex.arousal"]
    .rolling(7)
    .mean()
    .reset_index(level=[0, 1], drop=True)
)
res["moving_average_valence"] = (
    res.groupby(["id"])["circumplex.valence"]
    .rolling(7)
    .mean()
    .reset_index(level=[0, 1], drop=True)
)
res["moving_average_screen"] = (
    res.groupby(["id"])["screen"].rolling(7).mean().reset_index(level=[0, 1], drop=True)
)
res["moving_average_sms"] = (
    res.groupby(["id"])["sms"].rolling(7).mean().reset_index(level=[0, 1], drop=True)
)
...
res["ema_communication"] = (
    res.groupby(["id"])["appCat.communication"]
    .ewm(span=7, adjust=False)
    .mean()
    .reset_index(level=[0, 1], drop=True)
)
res["ema_entertainment"] = (
    res.groupby(["id"])["appCat.entertainment"]
    .ewm(span=7, adjust=False)
    .mean()
    .reset_index(level=[0, 1], drop=True)
...
res[
    [
        ...
        "moving_average_communication",
        "moving_average_entertainment",
        "moving_average_finance",
        "moving_average_game",
        "moving_average_office",
        "moving_average_other",
        "moving_average_social",
        "moving_average_travel",
        "moving_average_unknown",
        "moving_average_utilities",
        "moving_average_weather",
        "moving_average_call",
        "moving_average_arousal",
        "moving_average_valence",
        "moving_average_screen",
        "moving_average_sms",
        "activity_shift_1d",
        "built_shift_1d",
        "communication_shift_1d",
        "entertainment_shift_1d",
        "finance_shift_1d",
        "game_shift_1d",
        "office_shift_1d",
        "other_shift_1d",
        ...
        "activity_shift_2d",
        "built_shift_2d",
        "communication_shift_2d",
        "entertainment_shift_2d",
        "finance_shift_2d",
        "game_shift_2d",
        "office_shift_2d",
        "other_shift_2d",
...
rfe = RFE(
    RandomForestRegressor(n_estimators=500, random_state=1), n_features_to_select=10
)
fit = rfe.fit(X, y)
