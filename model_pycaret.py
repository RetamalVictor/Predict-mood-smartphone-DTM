...
for g in grouped.groups:
    ...
    train_test_set, val_set= train_test_split(group, test_size=0.15, shuffle= False, random_state=42)
    train_test_set['id'] = g
    val_set['id'] =  g
...
for i in tqdm(all_ts):
    ...
    s = setup(df_res, target = 'mood', train_size = 0.8,
...
final_val_df = pd.merge(val, concat_val, how = 'left', left_on=['id', 'Date'], right_on = ['id', 'Date'])
